...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    news: Schema.Attribute.Relation<'manyToMany', 'api::post.post'>;
    publishedAt: Schema.Attribute.DateTime;
    schoolLife: Schema.Attribute.Relation<'manyToMany', 'api::album.album'>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    achievements: Schema.Attribute.Component<'shared.achievement-item', true>;
